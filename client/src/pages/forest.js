...
import styles from '../styles/forest.module.css'; // 确保路径正确
...
export default function MySplineScene() {
    ...
    const introTextRef = useRef(null); // 使用ref来访问当前显示的文本DOM
    ...
    useEffect(() => {
        if (introTextRef.current) {
            ...
            if (blinkText) {
                blinkText.style.top = `${bottom + 20}px`; // 将提示文本定位到当前文本的下方
            }
        }
    }, [introTextIndex]);
